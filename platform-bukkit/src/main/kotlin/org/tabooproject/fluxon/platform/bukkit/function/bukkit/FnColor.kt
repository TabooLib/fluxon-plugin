...
object FnColor {
    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            ...
            registerFunction("color", returns(FnColor.TYPE).params(Type.I)) { it.setReturnRef(Color.fromRGB(it.getAsInt(0))) }
            // Color - RGB 三参数版本
            registerFunction("color", returns(FnColor.TYPE).params(Type.I, Type.I, Type.I)) { it.setReturnRef(Color.fromRGB(it.getAsInt(0), it.getAsInt(1), it.getAsInt(2))) }
        ...
        with(FluxonRuntime.getInstance()) {
            registerExtension(Color::class.java)
                ...
                .function("fromARGB",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnColor.TYPE).params(Type.I)) {
                    it.setReturnRef(Color.fromARGB(it.getAsInt(0).toInt()))
                }
                ...
                .function("fromRGB",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnColor.TYPE).params(Type.I)) {
                    it.setReturnRef(Color.fromRGB(it.getAsInt(0).toInt()))
                }
                ...
                .function("fromBGR",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnColor.TYPE).params(Type.I)) {
                    it.setReturnRef(Color.fromBGR(it.getAsInt(0).toInt()))
                }
                ...
                .function("setAlpha",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnColor.TYPE).params(Type.I)) { it.setReturnRef(it.target?.setAlpha(it.getAsInt(0).toInt())) }
                .function("red", returns(Type.I).noParams()) { it.setReturnInt(it.target?.red ?: 0) }
                .function("setRed",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnColor.TYPE).params(Type.I)) { it.setReturnRef(it.target?.setRed(it.getAsInt(0).toInt())) }
                .function("green", returns(Type.I).noParams()) { it.setReturnInt(it.target?.green ?: 0) }
                .function("setGreen",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnColor.TYPE).params(Type.I)) { it.setReturnRef(it.target?.setGreen(it.getAsInt(0).toInt())) }
                .function("blue", returns(Type.I).noParams()) { it.setReturnInt(it.target?.blue ?: 0) }
                .function("setBlue",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnColor.TYPE).params(Type.I)) { it.setReturnRef(it.target?.setBlue(it.getAsInt(0).toInt())) }
