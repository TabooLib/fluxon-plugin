...
@Requires(classes = ["org.bukkit.conversations.PlayerNamePrompt"])
@PlatformSide(Platform.BUKKIT)
object FnPlayerNamePrompt {

    val TYPE = Type.fromClass(org.bukkit.conversations.PlayerNamePrompt::class.java)

    @Awake(LifeCycle.INIT)
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(org.bukkit.conversations.PlayerNamePrompt::class.java)
                ...
                // .function("acceptValidatedInput", returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.conversations.FnPrompt.TYPE).params(org.tabooproject.fluxon.platform.bukkit.function.bukkit.conversations.FnConversationContext.TYPE, org.tabooproject.fluxon.platform.bukkit.function.bukkit.entity.FnPlayer.TYPE)) { it.setReturnRef(it.target?.acceptValidatedInput(it.getRef(0) as org.bukkit.conversations.ConversationContext, it.getRef(1) as org.bukkit.entity.Player)) }
        }
    }
}
