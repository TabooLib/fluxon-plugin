        ...
        with(FluxonRuntime.getInstance()) {
            registerExtension(Boat::class.java)
                ...
                .function("setOccupiedDeceleration", returnsVoid().params(Type.D)) {
                    it.target?.setOccupiedDeceleration(it.getAsDouble(0))
                }
                ...
                .function("setUnoccupiedDeceleration", returnsVoid().params(Type.D)) {
                    it.target?.setUnoccupiedDeceleration(it.getAsDouble(0))
                }
...
@PlatformSide(Platform.BUKKIT)
object FnBoatType : org.tabooproject.fluxon.platform.bukkit.function.FnEnumGetter<org.bukkit.entity.Boat.Type>(org.bukkit.entity.Boat.Type::class.java) {
