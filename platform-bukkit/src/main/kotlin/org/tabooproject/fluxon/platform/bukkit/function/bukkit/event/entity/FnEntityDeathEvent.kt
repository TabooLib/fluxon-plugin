...
//                .function("setReviveHealth",returns(Type.OBJECT).params(Type.D)) { it.setReturnRef(it.target?reviveHealth = it.getAsDouble(0)) }
                ...
                .function("setDroppedExp", returnsVoid().params(Type.I)) { it.target?.setDroppedExp(it.getAsInt(0).toInt()) }
