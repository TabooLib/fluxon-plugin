    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(Attributable::class.java)
                ...
                .syncFunction("setBaseArmor",returns(FnAttributeInstance.TYPE).params(Type.D)) { it.setReturnRef(it.target?.getAttribute(Attribute.GENERIC_ARMOR)?.apply { baseValue = it.getAsDouble(0) }) }
                ...
                .syncFunction("setBaseArmorToughness",returns(FnAttributeInstance.TYPE).params(Type.D)) {
                ...
                .syncFunction("setBaseAttackDamage",returns(FnAttributeInstance.TYPE).params(Type.D)) {
                ...
                .syncFunction("setBaseFlyingSpeed",returns(FnAttributeInstance.TYPE).params(Type.D)) {
                ...
                .syncFunction("setBaseFollowRange",returns(FnAttributeInstance.TYPE).params(Type.D)) {
                ...
                .syncFunction("setBaseLuck",returns(FnAttributeInstance.TYPE).params(Type.D)) { it.setReturnRef(it.target?.getAttribute(Attribute.GENERIC_LUCK)?.apply { baseValue = it.getAsDouble(0) }) }
                ...
                .syncFunction("setBaseMaxHealth",returns(FnAttributeInstance.TYPE).params(Type.D)) {
                ...
                .syncFunction("setBaseMovementSpeed",returns(FnAttributeInstance.TYPE).params(Type.D)) {
