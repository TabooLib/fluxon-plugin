...
object FnFireworkExplodeEvent {
    ...
    val TYPE = Type.fromClass(FireworkExplodeEvent::class.java)
    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(FireworkExplodeEvent::class.java)
                ...
                // static
                .function("handlerList",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.event.FnHandlerList.TYPE).noParams()) { it.setReturnRef(FireworkExplodeEvent.getHandlerList()) }
        }
    }
}
