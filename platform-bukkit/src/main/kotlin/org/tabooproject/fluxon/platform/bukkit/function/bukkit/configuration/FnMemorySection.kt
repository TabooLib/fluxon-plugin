...
@Requires(classes = ["org.bukkit.configuration.MemorySection"])
    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(MemorySection::class.java)
                .function("getKeys", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getKeys(it.getBool(0))) }
                ...
                .function("isSet", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isSet(it.getString(0)!!)) }
                ...
                .function("addDefault", returnsObject().params(Type.OBJECT, Type.OBJECT)) { it.setReturnRef(it.target?.addDefault(it.getString(0)!!, it.getRef(1))) }
                .function("defaultSection", returnsObject().noParams()) { it.setReturnRef(it.target?.defaultSection) }
                .function("set", returnsObject().params(Type.OBJECT, Type.OBJECT)) { it.setReturnRef(it.target?.set(it.getString(0)!!, it.getRef(1))) }
                ...
                .function("isString", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isString(it.getString(0)!!)) }
                ...
                .function("isInt", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isInt(it.getString(0)!!)) }
                ...
                .function("isBoolean", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isBoolean(it.getString(0)!!)) }
                ...
                .function("isDouble", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isDouble(it.getString(0)!!)) }
                ...
                .function("isLong", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isLong(it.getString(0)!!)) }
                .function("isList", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isList(it.getString(0)!!)) }
                .function("getStringList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getStringList(it.getString(0)!!)) }
                .function("getIntegerList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getIntegerList(it.getString(0)!!)) }
                .function("getBooleanList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getBooleanList(it.getString(0)!!)) }
                .function("getDoubleList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getDoubleList(it.getString(0)!!)) }
                .function("getFloatList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getFloatList(it.getString(0)!!)) }
                .function("getLongList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getLongList(it.getString(0)!!)) }
                .function("getByteList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getByteList(it.getString(0)!!)) }
                .function("getCharacterList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getCharacterList(it.getString(0)!!)) }
                .function("getShortList", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getShortList(it.getString(0)!!)) }
                ...
                .function("isVector", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isVector(it.getString(0)!!)) }
                ...
                .function("isOfflinePlayer", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isOfflinePlayer(it.getString(0)!!)) }
                ...
                .function("isItemStack", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isItemStack(it.getString(0)!!)) }
                ...
                .function("isColor", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isColor(it.getString(0)!!)) }
                ...
                .function("isLocation", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isLocation(it.getString(0)!!)) }
                .function("getConfigurationSection", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getConfigurationSection(it.getString(0)!!)) }
                .function("isConfigurationSection", returns(Type.Z).params(Type.OBJECT)) { it.setReturnRef(it.target?.isConfigurationSection(it.getString(0)!!)) }
                // static
                .function("createPath", returnsObject().params(Type.OBJECT, Type.OBJECT)) {
                ...
                .function("createPath", returnsObject().params(Type.OBJECT, Type.OBJECT, Type.OBJECT)) {
                    it.setReturnRef(if (it.argumentCount == 2) {
                        MemorySection.createPath(
                            it.getRef(0) as ConfigurationSection,
                            it.getString(1)
                ...
                .function("getComments", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getComments(it.getString(0)!!)) }
                .function("getInlineComments", returnsObject().params(Type.OBJECT)) { it.setReturnRef(it.target?.getInlineComments(it.getString(0)!!)) }
                .function("setComments", returnsObject().params(Type.OBJECT, Type.OBJECT)) {
                    it.setReturnRef(it.target?.setComments(
                        it.getString(0)!!,
                        it.getRef(1) as List<String>
                    ))
                }
                .function("setInlineComments", returnsObject().params(Type.OBJECT, Type.OBJECT)) {
                    it.setReturnRef(it.target?.setInlineComments(
                        it.getString(0)!!,
                        it.getRef(1) as List<String>
                    ))
                }
