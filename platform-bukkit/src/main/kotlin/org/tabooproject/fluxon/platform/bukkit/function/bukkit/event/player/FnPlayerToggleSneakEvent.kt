...
object FnPlayerToggleSneakEvent {
    ...
    val TYPE = Type.fromClass(PlayerToggleSneakEvent::class.java)
    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(PlayerToggleSneakEvent::class.java)
                ...
                // static
                .function("handlerList",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.event.FnHandlerList.TYPE).noParams()) { it.setReturnRef(PlayerToggleSneakEvent.getHandlerList()) }
        }
    }
}
