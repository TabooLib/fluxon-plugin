...
object FnConversationCanceller {

    val TYPE = Type.fromClass(org.bukkit.conversations.ConversationCanceller::class.java)

    @Awake(LifeCycle.INIT)
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(org.bukkit.conversations.ConversationCanceller::class.java)
