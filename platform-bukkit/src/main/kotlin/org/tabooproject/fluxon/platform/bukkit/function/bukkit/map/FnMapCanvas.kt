    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(MapCanvas::class.java)
                ...
                .function("cursors",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.map.FnMapCursorCollection.TYPE).noParams()) { it.setReturnRef(it.target?.cursors) }
