    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(org.bukkit.scheduler.BukkitRunnable::class.java)
                ...
                .function("runTaskLater", returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.scheduler.FnBukkitTask.TYPE).params(org.tabooproject.fluxon.platform.bukkit.function.bukkit.plugin.FnPlugin.TYPE, Type.J)) { it.setReturnRef(it.target?.runTaskLater(it.getRef(0) as org.bukkit.plugin.Plugin, it.getAsLong(1).toLong())) }
                .function("runTaskLaterAsynchronously", returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.scheduler.FnBukkitTask.TYPE).params(org.tabooproject.fluxon.platform.bukkit.function.bukkit.plugin.FnPlugin.TYPE, Type.J)) { it.setReturnRef(it.target?.runTaskLaterAsynchronously(it.getRef(0) as org.bukkit.plugin.Plugin, it.getAsLong(1).toLong())) }
                .function("runTaskTimer", returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.scheduler.FnBukkitTask.TYPE).params(org.tabooproject.fluxon.platform.bukkit.function.bukkit.plugin.FnPlugin.TYPE, Type.J, Type.J)) { it.setReturnRef(it.target?.runTaskTimer(it.getRef(0) as org.bukkit.plugin.Plugin, it.getAsLong(1).toLong(), it.getAsLong(2).toLong())) }
                .function("runTaskTimerAsynchronously", returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.scheduler.FnBukkitTask.TYPE).params(org.tabooproject.fluxon.platform.bukkit.function.bukkit.plugin.FnPlugin.TYPE, Type.J, Type.J)) { it.setReturnRef(it.target?.runTaskTimerAsynchronously(it.getRef(0) as org.bukkit.plugin.Plugin, it.getAsLong(1).toLong(), it.getAsLong(2).toLong())) }
