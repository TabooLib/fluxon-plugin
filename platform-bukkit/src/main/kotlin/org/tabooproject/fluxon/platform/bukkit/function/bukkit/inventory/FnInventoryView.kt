    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(InventoryView::class.java)
                ...
                .function("setItem", returnsVoid().params(Type.I, Type.OBJECT)) { it.target?.setItem(it.getInt(0).toInt(), it.getRef(1) as ItemStack) }
                ...
                .function("getInventory", returnsObject().params(Type.I)) { it.setReturnRef(it.target?.getInventory(it.getInt(0).toInt())) }
                ...
                .function("setProperty", returns(Type.Z).params(Type.OBJECT, Type.I)) {
...
object FnInventoryViewProperty {
    ...
    val TYPE = Type.fromClass(InventoryView.Property::class.java)
