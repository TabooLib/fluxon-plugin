    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(EntityToggleSwimEvent::class.java)
                ...
                // static
                .function("handlerList",returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.event.FnHandlerList.TYPE).noParams()) { it.setReturnRef(EntityToggleSwimEvent.getHandlerList()) }
        }
    }
}
