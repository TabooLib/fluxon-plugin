    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(ChunkGenerator.ChunkData::class.java)
                ...
                .function("getBiome", returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.block.FnBiome.TYPE).params(Type.I, Type.I, Type.I)) { it.setReturnRef(it.target?.getBiome(it.getAsInt(0).toInt(), it.getAsInt(1).toInt(), it.getAsInt(2).toInt())) }
                .function("setBlock", returnsVoid().params(Type.I, Type.I, Type.I, org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnMaterial.TYPE)) { it.target?.setBlock(it.getAsInt(0).toInt(), it.getAsInt(1).toInt(), it.getAsInt(2).toInt(), it.getRef(3) as Material) }
                .function("setBlock", returnsVoid().params(Type.I, Type.I, Type.I, org.tabooproject.fluxon.platform.bukkit.function.bukkit.material.FnMaterialData.TYPE)) { it.target?.setBlock(it.getAsInt(0).toInt(), it.getAsInt(1).toInt(), it.getAsInt(2).toInt(), it.getRef(3) as MaterialData) }
                .function("setBlock", returnsVoid().params(Type.I, Type.I, Type.I, org.tabooproject.fluxon.platform.bukkit.function.bukkit.block.data.FnBlockData.TYPE)) { it.target?.setBlock(it.getAsInt(0).toInt(), it.getAsInt(1).toInt(), it.getAsInt(2).toInt(), it.getRef(3) as BlockData) }
                .function("setRegion", returnsVoid().params(Type.I, Type.I, Type.I, Type.I, Type.I, Type.I, org.tabooproject.fluxon.platform.bukkit.function.bukkit.FnMaterial.TYPE)) { it.target?.setRegion(it.getAsInt(0).toInt(), it.getAsInt(1).toInt(), it.getAsInt(2).toInt(), it.getAsInt(3).toInt(), it.getAsInt(4).toInt(), it.getAsInt(5).toInt(), it.getRef(6) as Material) }
                .function("setRegion", returnsVoid().params(Type.I, Type.I, Type.I, Type.I, Type.I, Type.I, org.tabooproject.fluxon.platform.bukkit.function.bukkit.material.FnMaterialData.TYPE)) { it.target?.setRegion(it.getAsInt(0).toInt(), it.getAsInt(1).toInt(), it.getAsInt(2).toInt(), it.getAsInt(3).toInt(), it.getAsInt(4).toInt(), it.getAsInt(5).toInt(), it.getRef(6) as MaterialData) }
                .function("setRegion", returnsVoid().params(Type.I, Type.I, Type.I, Type.I, Type.I, Type.I, org.tabooproject.fluxon.platform.bukkit.function.bukkit.block.data.FnBlockData.TYPE)) { it.target?.setRegion(it.getAsInt(0).toInt(), it.getAsInt(1).toInt(), it.getAsInt(2).toInt(), it.getAsInt(3).toInt(), it.getAsInt(4).toInt(), it.getAsInt(5).toInt(), it.getRef(6) as BlockData) }
