    ...
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(org.bukkit.conversations.ConversationFactory::class.java)
                ...
                .function("withTimeout", returns(org.tabooproject.fluxon.platform.bukkit.function.bukkit.conversations.FnConversationFactory.TYPE).params(Type.I)) { it.setReturnRef(it.target?.withTimeout(it.getAsInt(0).toInt())) }
