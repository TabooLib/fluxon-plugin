...
@Requires(classes = ["org.bukkit.conversations.ManuallyAbandonedConversationCanceller"])
@PlatformSide(Platform.BUKKIT)
object FnManuallyAbandonedConversationCanceller {

    val TYPE = Type.fromClass(org.bukkit.conversations.ManuallyAbandonedConversationCanceller::class.java)

    @Awake(LifeCycle.INIT)
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(org.bukkit.conversations.ManuallyAbandonedConversationCanceller::class.java)
