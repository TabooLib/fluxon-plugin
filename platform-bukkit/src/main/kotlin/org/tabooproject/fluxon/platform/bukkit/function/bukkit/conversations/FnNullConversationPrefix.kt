...
object FnNullConversationPrefix {

    val TYPE = Type.fromClass(org.bukkit.conversations.NullConversationPrefix::class.java)

    @Awake(LifeCycle.INIT)
    private fun init() {
        with(FluxonRuntime.getInstance()) {
            registerExtension(org.bukkit.conversations.NullConversationPrefix::class.java)
